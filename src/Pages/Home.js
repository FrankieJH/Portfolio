            ...
            <div className="Hero_section">
                ...
                <div className="Hero_center">
                    ...
                    <h1 className="Font_style_1" 
                        id="Hero_center_child_2">FRANKIE<span id="Font_style_1_transparent">HRNDZ</span></h1>
                    <p className="Font_style_2"
                       id="Hero_center_child_3">I am passionate about crafting visually stunning and 
